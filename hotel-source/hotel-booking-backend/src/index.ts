...
// IMPORTANT: registered AFTER cors() above, so rate-limited (429) responses
// still carry Access-Control-Allow-Origin headers instead of failing as a
// false-looking CORS error in the browser. OPTIONS preflight requests are
// also skipped entirely so they never count against either limit.
