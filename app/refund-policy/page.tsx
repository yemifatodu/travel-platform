...
export const metadata: Metadata = {
  ...
  description: 'Our cancellation and refund policies explained clearly.',
}
    ...
    <div style={{ minHeight: '100vh', background: '#080807', paddingTop: 120 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '80px 60px' }}>
        ...
        <div style={{ marginBottom: 64 }}>
          ...
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(3rem, 6vw, 6rem)', fontWeight: 300, color: '#F5EFE4', lineHeight: 1, marginBottom: 24 }}>Refund & Cancellation Policy</h1>
          <p style={{ color: 'rgba(245,239,228,0.55)', fontSize: '1rem', maxWidth: 600, lineHeight: 1.8 }}>Our cancellation and refund policies explained clearly.</p>
        </div>
        {/* Coming Soon Notice */}
