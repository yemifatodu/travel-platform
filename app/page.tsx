...
const HotelIcon = ({ className = '' }: { className?: string }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={gold} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
const CarIcon = ({ className = '' }: { className?: string }) => (
  <svg className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke={gold} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
    <path d="M5 17h14v-4H5v4ZM3 13V7a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v6M7 17v2a2 2 0 0 0 2 2h0a2 2 0 0 0 2-2v-2M15 17v2a2 2 0 0 0 2 2h0a2 2 0 0 0 2-2v-2"/>
  </svg>
)

const MountainIcon = ({ className = '' }: { className?: string }) => (
  <svg className={className} width="48" height="48" viewBox="0 0 24 24" fill="none" stroke={gold} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
export default function HomePage() {
  ...
  const tabs = [{ label: 'Flights', icon: <PlaneIcon className="inline mr-1" />, link: '/' }]
        ...
        <div style={{ maxWidth: 960, margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit,minmax(240px,1fr))', gap: 'clamp(24px,3.2vw,40px)', alignItems: 'center' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 2 }}>
              {[
                { icon: <PlaneIcon className="mb-2" />, title: 'All In One Place', body: 'Flights, hotels, tours, eSIMs, transfers and experiences — without ever leaving HUUBOI.' },
                { icon: <CompassIcon className="mb-2" />, title: 'Expert Guides', body: 'Deep destination guides written by people who have actually been there.' },
                { icon: <LightbulbIcon className="mb-2" />, title: 'Smarter Decisions', body: 'Visa requirements, best seasons, budget guides and insider tips on every page.' },
                { icon: <GlobeIcon className="mb-2" />, title: 'Six Continents', body: '194 destinations across Africa, Middle East, Asia, Europe, the Americas and the Pacific.' },
              ].map(item => (
      ...
      <section style={{ background: '#0d0c0a', borderBottom: '1px solid rgba(200,169,110,0.12)' }} className="page-pad">
        <div style={{ maxWidth: 1200, margin: '0 auto', padding: '30px 0' }}>
          <div style={{ display: 'flex', gap: 0, marginBottom: 20, borderBottom: '1px solid rgba(200,169,110,0.15)', overflowX: 'auto' }}>
            {tabs.map((tab, i) => (
              <a key={tab.label} href={tab.link} style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: '0.7rem', letterSpacing: '0.12em', padding: '12px 14px', background: 'none', border: 'none', color: activeTab === i ? '#C8A96E' : 'rgba(245,239,228,0.60)', borderBottom: activeTab === i ? '2px solid #C8A96E' : '2px solid transparent', cursor: 'pointer', whiteSpace: 'nowrap', transition: 'color 0.2s', textDecoration: 'none', display: 'flex', alignItems: 'center' }}>
                {tab.icon}{tab.label}
              </a>
            ))}
          </div>
          ...
          <div className="responsive-flex-cards" style={{ display: 'flex', flexDirection: 'row', flexWrap: 'wrap', gap: 16, marginTop: '20px' }}>
            ...
            <Link href="/hotel" style={{ flex: '1 1 300px', textDecoration: 'none', background: '#111110', border: '1px solid rgba(200,169,110,0.15)', padding: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <div style={{ marginBottom: '5px' }}><HotelIcon /></div>
            ...
            <Link href="/transfers" style={{ flex: '1 1 300px', textDecoration: 'none', background: '#111110', border: '1px solid rgba(200,169,110,0.15)', padding: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <div>
                <div style={{ marginBottom: '5px' }}><CarIcon /></div>
      ...
      <section className="section-pad page-pad" style={{ background: '#080807', padding: '40px 0' }}>
        <div style={{ maxWidth: 1200, margin: '0 auto' }}>
          ...
          <div style={{ background: '#111110', border: '1px solid rgba(200,169,110,0.15)', padding: '30px', textAlign: 'center', marginBottom: '20px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '150px' }}>
             <div style={{ marginBottom: '10px' }}><MountainIcon /></div>
              ...
              <div className="test-grid">
                {testimonials.map(t => (
                  <div key={t.name} style={{ background: '#1C1B18', border: '1px solid rgba(200,169,110,0.1)', padding: '15px' }}>
                    <div style={{ color: '#C8A96E', fontSize: '0.75rem', marginBottom: 10, display: 'flex', gap: 2 }}>
