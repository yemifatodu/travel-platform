              ...
              <div key={dest.slug}
                ...
                <div style={{ position: 'relative', height: 130 }}>
                  ...
                  <div style={{ position: 'absolute', bottom: 14, left: 18, zIndex: 2 }}>
                    <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: '0.6rem', letterSpacing: '0.15em', color: gold, background: 'rgba(0,0,0,0.5)', padding: '2px 8px', borderRadius: '4px' }}>
                      {dest.country}
                    </div>
                  </div>
                </div>
                ...
                <div style={{ padding: '20px 22px 22px' }}>
                  ...
                  {/* Expandable Description - REPLACES the old truncated paragraph */}
