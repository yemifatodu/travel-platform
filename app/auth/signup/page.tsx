    ...
    <div style={{ minHeight: '100vh', background: '#080807', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '120px 20px 60px' }}>
      <div style={{ width: '100%', maxWidth: 460 }}>
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '0.65rem', letterSpacing: '0.35em', color: '#C8A96E', marginBottom: 16 }}>JOIN FOR FREE</div>
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(2.5rem, 6vw, 4rem)', fontWeight: 300, color: '#F5EFE4', lineHeight: 1 }}>Create Account</h1>
        </div>
          ...
          {!success && (
            <form onSubmit={handleSignup}>
              <div style={{ marginBottom: 20 }}>
                <label style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '0.6rem', letterSpacing: '0.2em', color: '#C8A96E', display: 'block', marginBottom: 8 }}>FULL NAME</label>
