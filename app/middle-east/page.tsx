...
const destinations = [
  {
    ...
    experiences: [
      'Sunrise at the Burj Khalifa observation deck (level 124)',
      'Private desert safari with glamping under the stars',
      'Dinner at At.mosphere — the world\'s highest restaurant',
      'Traditional abra crossing on Dubai Creek',
      'Afternoon at the Dubai Mall and Burj Lake fountain show',
      'Sunset drinks at Cé La Vi rooftop',
    ],
    hotels: ['Burj Al Arab Jumeirah', 'Atlantis The Royal', 'Four Seasons DIFC', 'One&Only The Palm', 'Waldorf Astoria Dubai'],
  },
  {
    slug: 'abu-dhabi',
    name: 'Abu Dhabi',
    ...
    experiences: [
      ...
      'Louvre Abu Dhabi — extraordinary architecture and art',
      'Yas Marina Circuit — drive the F1 track',
      'Empty Quarter desert excursion to the Liwa Oasis',
      'Qasr Al Hosn heritage site',
      'Saadiyat Island beach and cultural district',
    ],
    hotels: ['Emirates Palace Mandarin Oriental', 'Qasr Al Sarab Desert Resort', 'St. Regis Saadiyat Island', 'Jumeirah at Saadiyat Island'],
  },
  {
    slug: 'alula',
    name: 'AlUla & Riyadh',
    ...
    experiences: [
      'Hegra UNESCO site — rock-cut Nabataean tombs at sunrise',
      'Elephant Rock at golden hour',
      'AlUla old town wander',
      'Edge of the World escarpment near Riyadh',
      'Diriyah heritage site — birthplace of the Saudi state',
      'Hot air balloon over AlUla valley',
    ],
    hotels: ['Banyan Tree AlUla', 'Shebara Resort AlUla', 'Habitas AlUla', 'Rosewood Diriyah'],
  },
  {
    slug: 'petra',
    name: 'Petra & Wadi Rum',
    ...
    experiences: [
      'Petra by Night — thousands of candles lining the Siq',
      'Petra Treasury at dawn — before the crowds arrive',
      'Wadi Rum 4WD and overnight Bedouin camp',
      'Float effortlessly in the Dead Sea',
      'Snorkelling and diving at Aqaba Red Sea',
      'Roman ruins at Jerash — one of the best-preserved outside Italy',
    ],
    hotels: ['Kempinski Hotel Ishtar Dead Sea', 'Six Senses Shaharut', 'Memories Aicha Petra', 'Captain\'s Desert Camp Wadi Rum'],
  },
  {
    slug: 'oman',
    name: 'Muscat & Oman',
    ...
    experiences: [
      ...
      'Dhow cruise through the Musandam fjords',
      'Wadi Shab gorge hike and swim through turquoise pools',
      'Overnight in a luxury desert camp in Wahiba Sands',
      'Nizwa Fort and Friday cattle market',
      'Swim in natural rock pools at Wadi Bani Khalid',
    ],
    hotels: ['Alila Jabal Akhdar', 'Six Senses Zighy Bay', 'The Chedi Muscat', 'Desert Nights Camp Wahiba'],
  },
  {
    slug: 'istanbul',
    name: 'Istanbul',
    ...
    experiences: [
      'Hagia Sophia and Blue Mosque — the heart of old Istanbul',
      'Grand Bazaar — 4,000 shops across 61 covered streets',
      'Sunset Bosphorus cruise with dinner',
      'Topkapi Palace and imperial treasury',
      'Spice Bazaar and Galata Bridge fish sandwiches',
      'Rooftop terrace drinks overlooking the Golden Horn',
    ],
    hotels: ['Four Seasons Istanbul at the Bosphorus', 'Çırağan Palace Kempinski', 'The Stay Bosphorus', 'Soho House Istanbul'],
  },
  {
    slug: 'cappadocia',
    name: 'Cappadocia',
    ...
    experiences: [
      'Hot air balloon at sunrise over the fairy chimneys',
      'Rose Valley sunset hike',
      'Underground city of Derinkuyu — 18 levels deep',
      'Göreme Open Air Museum — Byzantine cave frescoes',
      'Horse trek through the Love Valley',
      'Dinner in a cave restaurant with live whirling dervish performance',
    ],
    hotels: ['Argos in Cappadocia', 'Museum Hotel Uçhisar', 'Kayakapi Premium Caves', 'Sultan Cave Suites'],
  },
  {
    slug: 'doha',
    name: 'Doha',
    ...
    experiences: [
      'Museum of Islamic Art — world-class collection in a stunning building',
      'Souq Waqif — traditional market with falconry and spices',
      'Inland Sea (Khor Al Adaid) — UNESCO-recognised desert sea',
      'The Pearl-Qatar — luxury island with marina and boutiques',
      'Katara Cultural Village amphitheatre',
      'Dhow harbour sunset',
    ],
    hotels: ['Mandarin Oriental Doha', 'Four Seasons Hotel Doha', 'The Ned Doha', 'Banana Island Resort'],
  },
]

const experienceTypes = [
  { icon: '🏙️', title: 'Luxury City Breaks', desc: 'Dubai and Abu Dhabi set the global standard for luxury hotels, fine dining and world-class shopping in a desert metropolis.' },
  { icon: '🏛️', title: 'Ancient Civilisations', desc: 'Petra, Hegra, Jerash and Cappadocia — the Middle East contains some of the world\'s most important and least visited archaeological sites.' },
...
const planningTips = [
  { icon: '👗', tip: 'Dress modestly in public areas — shoulders and knees covered, especially near mosques and traditional markets.' },
  { icon: '🕌', tip: 'Respect mosque rules — remove shoes, women cover hair. Non-Muslims are welcome in most major mosques outside prayer times.' },
  { icon: '🍷', tip: 'Alcohol laws vary sharply — legal in UAE, Qatar, Oman (hotels only), Turkey, Jordan. Illegal in Saudi Arabia. Never drink in public.' },
  { icon: '📸', tip: 'Ask before photographing people, especially women and anyone in uniform. Military and government buildings are prohibited.' },
  { icon: '💵', tip: 'Cash is still king in traditional markets and taxis. US dollars widely accepted in Gulf, but Jordan and Turkey prefer local currency.' },
  { icon: '🌡️', tip: 'Summer (Jun–Aug) in Gulf states is extreme (45°C+). Plan indoor activities. Winter (Nov–Mar) is peak season with perfect weather.' },
]
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#080807', paddingTop: 90 }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: 'clamp(40px,6vw,80px) clamp(20px,5vw,60px)' }}>
        ...
        {/* DESTINATIONS TAB - NOW FULLY RENDERED */}
        ...
        {activeTab === 'experiences' && (
          <div>
            ...
            {/* Season Guide - Enhanced */}
            <div style={{ background: '#111110', border: '1px solid rgba(200,169,110,0.15)', padding: 'clamp(28px,4vw,48px)' }}>
              <div style={{ fontFamily: "'Bebas Neue',sans-serif", fontSize: '0.7rem', letterSpacing: '0.25em', color: gold, marginBottom: 28 }}>MIDDLE EAST BY SEASON</div>
