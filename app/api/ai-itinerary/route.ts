// app/api/ai-itinerary/route.ts — FIXED: Create Supabase client inside handler
...
// ✅ Helper: Create Supabase client at runtime (not build time)
...
export async function POST(req: NextRequest) {
  try {
    // ✅ Create client INSIDE function (runtime, not build time)
