    ...
    <div style={{ minHeight: '100vh', background: '#080807', paddingTop: 120 }}>
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '80px 60px' }}>
        <div style={{ marginBottom: 64 }}>
          <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '0.7rem', letterSpacing: '0.3em', color: '#C8A96E', marginBottom: 16 }}>OUR STORY</div>
          <h1 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 'clamp(3rem, 6vw, 6rem)', fontWeight: 300, color: '#F5EFE4', lineHeight: 1, marginBottom: 24 }}>About Us</h1>
          <p style={{ color: 'rgba(245,239,228,0.55)', fontSize: '1rem', maxWidth: 600, lineHeight: 1.8 }}>Our story, mission, and the team behind the world's most curated travel platform.</p>
        </div>
        <div style={{ border: '1px solid rgba(200,169,110,0.2)', padding: '48px', background: '#1C1B18', maxWidth: 600 }}>
          ...
          <p style={{ color: 'rgba(245,239,228,0.5)', fontSize: '0.9rem', lineHeight: 1.7, marginBottom: 32 }}>
            Connect your APIs, add your content, and this page will come to life.
          </p>
