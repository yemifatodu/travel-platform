// app/travel-guides/guidesData.ts

export const gold = '#C8A96E'
export const cream = '#F5EFE4'
export const muted = 'rgba(245,239,228,0.60)'
export const dim = 'rgba(245,239,228,0.35)'
...
export const categories = ['All', 'Luxury', 'Culture & Nature', 'Wildlife & Safari', 'Adventure', 'City Break', 'Beach & Romance', 'Culture & Food', 'Luxury & Romance', 'Culture & Adventure', 'Adventure & History']
export const regions = ['All', 'Africa', 'Middle East', 'Asia', 'Europe', 'Americas']