...
export function Footer() {
  ...
  const socials = [
    ...
    {
      name: 'Medium',  // ADDED: Medium social media
      url: 'https://medium.com/@huuboicom',  // Replace with your actual Medium URL
      icon: 'medium',
    },
  ]
  ...
  const SocialIcon = ({ type }: { type: string }) => {
    ...
    switch (type) {
      ...
      // ADDED: Medium icon SVG
      case 'medium':
        return (
          <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor">
            <path d="M2.846 6.887c.03-.295-.083-.586-.303-.784l-2.24-2.7v-.403h6.958l5.378 11.795 4.728-11.795h6.633v.403l-1.916 1.837c-.165.126-.247.333-.213.53v13.277c-.034.197.048.404.213.53l1.87 1.837v.403h-9.412v-.403l1.937-1.88c.19-.19.19-.246.19-.53v-10.74l-5.384 13.68h-.73l-6.274-13.68v9.174c-.052.385.076.774.348 1.053l2.52 3.06v.403h-7.14v-.403l2.52-3.06c.27-.279.39-.67.324-1.053v-10.6z"/>
          </svg>
        )
  ...
  return (
    ...
    >
      <style>{`
        ...
        /* Desktop: 5 columns (brand + 4 content columns) */
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        <div className="footer-grid">
          ...
          <div className="brand-col">
            ...
            <div className="social-icons" style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              {socials.map((s) => (
                <a
                  key={s.name}
                  href={s.url}
          ...
          {/* COLUMNS - Vertical link lists (not pills) */}
          {cols.map((col) => (
        ...
        {/* BOTTOM */}
        <div className="footer-bottom" style={{ borderTop: '1px solid rgba(200,169,110,0.1)', paddingTop: 20, marginTop: 20 }}>
